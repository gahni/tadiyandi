...
ACMD_FUNC(go)
{
	...
	const struct {
		...
		{ MAP_PRONTERA,    155, 173 }, //  0=Prontera
...
ACMD_FUNC(monster)
{
	...
	// If value of atcommand__quantity_limit directive is greater than or equal to 1 and quantity of monsters is greater than value of the directive
